...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/jilbab.jpeg" class="brand">
			...
			<ul>
				<li>
					<a href="<?php echo URL; ?>/dashboard">
						<img class="icon" src="<?php echo AST; ?>/img/rumah.png" alt=""> Home
					</a>
				</li>
				<li>
				...
				<li>
					<a href="<?php echo URL; ?>/users">
						<img class="icon" src="<?php echo AST; ?>/img/user3.png" alt=""> Data Users
					</a>
				</li>
				<li>
					<a href="<?php echo URL; ?>/pelanggan">
						<img class="icon" src="<?php echo AST; ?>/img/pelanggan2.png" alt=""> Data Pelanggan
					</a>
				</li>
				<li>
